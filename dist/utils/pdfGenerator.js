...
exports.generateProductSummaryPDF = exports.generateAfCFTACorporateForm = void 0;
const pdf_lib_1 = require("pdf-lib");
const generateAfCFTACorporateForm = async () => {
...
exports.generateAfCFTACorporateForm = generateAfCFTACorporateForm;
const generateProductSummaryPDF = async (product) => {
    const pdfDoc = await pdf_lib_1.PDFDocument.create();
    ...
    page.drawText('AfCFTA Product Summary Report', {
        ...
        size: 16,
        font,
        color: (0, pdf_lib_1.rgb)(0, 0.2, 0.6),
    });
    y -= 30;
...
exports.generateProductSummaryPDF = generateProductSummaryPDF;
